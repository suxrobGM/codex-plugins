...
- A first-pass score from a results row needs only `title`, `company`, `skills`, and a short excerpt. A thin/generic row is **not** a skip - open the posting and enrich the digest before scoring it out.

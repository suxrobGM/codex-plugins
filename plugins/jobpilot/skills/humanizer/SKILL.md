...
description: |
  ...
  voice, negative parallelisms, filler phrases, paragraph-final tie-backs,
...
metadata:
  ...
  # Patterns 34-36 and the PTY note in §14 are JobPilot additions - re-apply them on the next sync.
  localPatterns: "34-36"
---
...
**Job-application writing sits in between.** A cover letter, proposal, or recruiter reply is first-person and should sound like a person, but the register stays professional. Take "vary your rhythm", "be specific", and "let some mess in" from below; leave "have opinions" and "acknowledge complexity" for essays.
...
JobPilot additions (34-36), for persuasive writing where the tell is paragraph shape, not word choice.

### 34. Paragraph-Final Tie-Backs (Mirroring the Reader)
...
### 35. Spaced Hyphens as Em-Dash Substitutes
...
File and embedded modes run the same loop and show less (see Invocation Modes).
